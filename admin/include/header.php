...
<html>
  <head>
    ...
    <title>Smart | Agriculture - Admin</title>
  <!-- favicon -->
    ...
    <body class="bg-light">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary static-top">
        <div class="container">
          ...
          <img src="../images/logo - Copy.png" alt="logo" style="height: 40px; width: 40px;" >Smart | Agriculture
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <!-- <li class="nav-item">
                  <a class="nav-link" href="index.php"><span class="fas fa-home"></span> Dasboard</a>
              </li> -->
              <li class="nav-item">
